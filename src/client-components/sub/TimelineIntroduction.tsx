  ...
  return (
    <div className="flex flex-col items-center text-white">
      <div className="text-base sm:text-lg text-left max-w-full sm:max-w-2xl my-4 border-2 border-white bg-black/50 rounded-lg px-4 sm:px-6 md:px-8 py-4">
        ...
        trọng. Đi kèm đó, là lịch sử Việt Nam với Trung Quốc luôn có những mốc
        thời gian liên quan tới nhau. Vậy nên, ở phần dòng thời gian, chúng ta
        sẽ tập trung vào các giai đoạn sau:
        ...
        <br />
        <strong>
          Ở Việt Nam, theo dòng thời gian trên, thì chúng ta có những triều đại
          sau:
        </strong>
        <br />- <em>Nhà Ngô (939–968)</em>: Triều đại đầu tiên sau khi thoát
        ...
        <br />
        <br />
        <strong>Các triều đại theo dòng thời gian ở Trung Quốc:</strong>
